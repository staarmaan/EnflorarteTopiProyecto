    ...
    public partial class InitialCreateSqlServer : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    arreglo_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nombre = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    foto_ruta = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    flor_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nombre = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    foto_ruta = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    descripcion = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    color_seleccionado = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    flor_inventario_color_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    flor_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cliente_telefono = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    link_direccion = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    domicilio_referencias = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    numero_ruta = table.Column<int>(type: "int", nullable: true),
                    NumeroPedido = table.Column<int>(type: "int", nullable: true),
                    MedioDeLaSolicitud = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    NombreReceptorEnvio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TelefonoReceptorEnvio = table.Column<int>(type: "int", nullable: true),
                    arreglo_id = table.Column<int>(type: "int", nullable: false),
                    NombreArreglo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FotoArregloRuta = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    cantidad_arreglo = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    mensaje_arreglo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    EvolturaArreglo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ColorEvolturaArreglo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AccesorioArreglo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TipoArreglo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CajaTipoArreglo = table.Column<string>(type: "nvarchar(max)", nullable: true),
